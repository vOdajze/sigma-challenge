...
_404 = {404: {"description": "Uso do solo não encontrado no dataset"}}
_422 = {422: {"description": "Dados inválidos ou coordenadas fora das geometrias"}}
...
@router.get("/usos-solo/{uso}", response_model=UsoSoloArea, responses={**_404})
